...
$subject ="Новая заявка с сайта dmitry's-portfolio.ru";
...
$mail = mail("dmitryymanakov@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
